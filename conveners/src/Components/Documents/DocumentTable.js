                        ...
                        .map((row, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell key={`location-${row._id}`} align={props.align || 'center'}>{`${row.previewLocations[0] || 'None'}`}</TableCell>
                                    <TableCell key={`registered-${row._id}`} align='center'>{`${row.documentLocations.length}`}</TableCell>
                                    <TableCell key={`left-${row._id}`} align='center'>{`${row.description}`}</TableCell>
                                </TableRow>
                            );
                        })}
                    {emptyRows > 0 && (
