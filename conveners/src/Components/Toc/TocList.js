                        ...
                        .map((row, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell key={`date-${row._id}`} align={props.align || 'center'}>
                                        <Box sx={{padding: '0 25%'}}>
                                            <ImgNextGen
                                    ...
                                    <TableCell key={`location-${row._id}`} align={props.align || 'center'}>{`${row.year}`}</TableCell>
                                    <TableCell key={`registered-${row._id}`} align='center'>{`${row.sections.length}`}</TableCell>
                                    <TableCell key={`left-${row._id}`} align='center'>{`${row.dates.length}`}</TableCell>
                                </TableRow>
                            );
                        })}
                    {emptyRows > 0 && (
