...
const Refund = () => {
    return <div className={styles.main}>
        ...
        <p>Thank you for shopping at SPFA Canada.</p>
        ...
        <ul>
            ...
            <li>
                <p>By visiting this page on our website: <a href="https://www.spfacanada.ca/returns-refunds" rel="external nofollow noopener" target="_blank">https://www.spfacanada.ca/returns-refunds</a></p>
            </li>
        </ul>
        ...
        <ul>
            <li>
                <p>The Goods were purchased in the last 45 days</p>
            </li>
            <li>
        ...
        <p>19 Cottonwood Drive, Belleville, ON, CA K8N 0J3</p>
