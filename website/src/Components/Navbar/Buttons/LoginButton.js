        ...
        return props.user ?
            <Fragment>
                <Tooltip title="Account settings">
                    ...
                    >
                        <Avatar sx={{ width: 24, height: 24 }} alt={`${props.user.name.givenName} ${props.user.name.familyName}`} src={props.user.profileImage ? props.user.profileImage : userIcon} />
                    </IconButton>
                </Tooltip>
                <Menu
                    anchorEl={anchorEl}
                ...
                >
                    <Box sx={{ display: 'flex', p: "2% 1rem", justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                        <Avatar
                            ...
                            src={props.user.profileImage ? props.user.profileImage : userIcon}
                    ...
                    {props.user.roles === 'Convener' && <MenuItem onClick={() => { window.location.replace(`/conveners/home/${props.user._id}`) }}>
                        <ListItemIcon>
                            <SportsIcon color="action" fontSize="small" />
                        </ListItemIcon>
                        Convener Panel
                    </MenuItem>}
                    {props.user.roles === 'admin' && <MenuItem onClick={() => { window.location.replace(`/conveners/home/${props.user._id}`) }}>
                        <ListItemIcon>
                            <SportsIcon color="action" fontSize="small" />
                        </ListItemIcon>
                        Convener Panel
